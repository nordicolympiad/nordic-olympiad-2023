...
\begin{tabular}{|l|l|l|}
    ...
    1     &  7   & $N \leq 1\,000$,          $M \leq 10$, $K = 1$ \\ \hline % simulation O(n) probably
    2     &  12  & $N \leq 1\,000$,          $M \leq 10$, $K \leq 2$ \\ \hline % DP with two machines O(n * m**2) probably
    3     &  22  & $N \leq 1\,000$,          $M \leq 10$, $K \leq 5$ \\ \hline % DP with complex state O(n * m * (m choose k)) or O(n * m * 2**m)
    4     &  11  & $N \leq 1\,000$,         $M \leq 200$, $K \leq 100$ \\ \hline % O(n**2 * k) or O(n * m * k) by pigeonhole principle
    5     &  14  & $N \leq 2 \cdot 10^5$, $M \leq 500$, $K \leq 100$ \\ \hline % O(n * m + n * k)
